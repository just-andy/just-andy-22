...
const Header = () => {
    ...
    return (
        <>
            <header className="flex justify-between p-4 font-normal font-sans flex-col md:flex-row md:px-8 md:py-4 ">
                <div className="flex flex-col items-center md:flex-row md:items-center">
                    <figure className="svg-container mt-2">
                    <svg width="100%" height="100%" className="w-36 h-36  md:w-16 lg:h-16" viewBox="0 0 148 148">
