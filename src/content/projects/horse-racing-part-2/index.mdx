...
<ImageText image="hr2-usertest-1" altText="User Testing Lab">
<h3>Round 1 - The Lab</h3>
 
 <p>This project actually started with a mobile prototype because we had a slot in our user testing lab coming up. In a&nbsp;change&nbsp;to our normal design&nbsp;process, we started with building our best guess. Because of the complexity of the prototype, I built out a functional racecard in HTML/CSS using the <a rel="noopener noreferrer nofollow" href="https://foundation.zurb.com/" target="_blank">Foundation for Sites</a> framework.</p>
...
<p>
 ...
 <p><b>Results: </b>Prototype 2 was the unanimous outcome as users found it more familiar. The product owner took this on board for the next stages along with the other feedback.</p>
</ImageText>
